...
This example is based on H3K4me1 peaks annotated with the Gencode genome [further details here](http://uropa.readthedocs.io/en/latest/uropa-example/#used-peak-and-annotation-files). 
